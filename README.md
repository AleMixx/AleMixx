...
<table>
  <tr>
    <td width="50%">
      ...
      A PWA for managing personal finances, built to replace an Excel spreadsheet.<br/>
      <b>Stack:</b> Cloudflare Workers (Hono) · D1 (SQLite) · Pages<br/>
      <b>Features:</b> multi-mode form, offline sync, history with inline edit, monthly charts
    </td>
    <td width="50%">
      <h4>🏃 Personal Garmin Dashboard</h4>
      A dashboard for analyzing sports performance from Garmin data.<br/>
      <b>Stack:</b> Python (FastAPI) · PostgreSQL · React<br/>
      <b>Features:</b> training load (CTL/ATL/TSB), pace/HR decoupling, Karvonen HR zones
    </td>
  </tr>
</table>
